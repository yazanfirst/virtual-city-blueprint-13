...
export const MIRROR_WORLD_LEVELS: MirrorWorldLevelConfig[] = [
  { level: 1, requiredAnchors: 2, baseTime: 110, anchorBonus: 10, shadowSpeed: 0.35, shadowCount: 1, collisionDistance: 1.8, lives: 3 },
  { level: 2, requiredAnchors: 3, baseTime: 105, anchorBonus: 9, shadowSpeed: 0.4, shadowCount: 2, collisionDistance: 1.9, lives: 3 },
  { level: 3, requiredAnchors: 4, baseTime: 100, anchorBonus: 8, shadowSpeed: 0.45, shadowCount: 2, collisionDistance: 2, lives: 2 },
  { level: 4, requiredAnchors: 5, baseTime: 95, anchorBonus: 8, shadowSpeed: 0.5, shadowCount: 3, collisionDistance: 2, lives: 2 },
  { level: 5, requiredAnchors: 5, baseTime: 90, anchorBonus: 7, shadowSpeed: 0.55, shadowCount: 3, collisionDistance: 2.1, lives: 2 },
];
